  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <h3 className={cn(
              ...
              task.completed ? 'text-gray-400 line-through' : isDark ? 'text-white' : 'text-gray-900'
            )}>
              {task.title}
            </h3>
          ...
          <div className={`flex items-center gap-6 text-sm ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
            {task.due_date && (
        ...
        <ChevronRight className={`w-5 h-5 ${isDark ? 'text-gray-400 group-hover:text-white' : 'text-gray-600 group-hover:text-gray-900'} transition-colors flex-shrink-0`} />
      </div>
    </div>
  )
}
      ...
      <GlassCard className="w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 border-b border-white/10 bg-gradient-to-r from-blue-500/10 to-purple-500/10">
          <div className="flex items-center justify-between">
            <div>
              <h2 className={`text-3xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>{task.title}</h2>
              <div className="flex items-center gap-4">
        ...
        <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 140px)' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Vänster kolumn */}
            <div>
              <h3 className={`text-xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-gray-900'}`}>Uppgiftsdetaljer</h3>
              
              <div className="space-y-4">
                {task.description && (
                  <div className="bg-white/5 p-4 rounded-lg">
                    <h4 className="text-sm font-medium text-gray-400 mb-2">Beskrivning</h4>
                    <p className={`leading-relaxed ${isDark ? 'text-white' : 'text-gray-800'}`}>{task.description}</p>
                  </div>
                )}
                ...
                {task.due_date && (
                  <div className="bg-white/5 p-4 rounded-lg">
                    ...
                    <p className={cn(
                      'font-medium',
                      isOverdue ? 'text-red-400' : isDark ? 'text-white' : 'text-gray-900'
                    )}>
                      {formatDate(task.due_date)}
                    </p>
                  </div>
                ...
                <div className="bg-white/5 p-4 rounded-lg">
                  ...
                  <p className={`${isDark ? 'text-white' : 'text-gray-900'}`}>{formatDate(task.created_at)}</p>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className={`text-4xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>Att göra</h1>
          <p className={`text-xl ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Håll koll på dina uppgifter - enkelt och tydligt</p>
        </div>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/10 border-blue-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>{todayTasks.length}</p>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-orange-500/10 to-orange-600/10 border-orange-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>{pendingTasks.length}</p>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-red-500/10 to-red-600/10 border-red-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>{overdueTasks.length}</p>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-green-500/10 to-green-600/10 border-green-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>{completedTasks.length}</p>
