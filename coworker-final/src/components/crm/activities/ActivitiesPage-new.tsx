      ...
      <GlassCard className="w-full max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 border-b border-white/10 bg-gradient-to-r from-blue-500/10 to-purple-500/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white mb-1">{activity.title}</h2>
        ...
        <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 140px)' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Vänster kolumn */}
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">Aktivitetsdetaljer</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 p-4 rounded-lg">
                  ...
                  <p className="text-white text-lg">{formatDate(activity.date, 'long')}</p>
                </div>

                {activity.duration_minutes && (
                  <div className="bg-white/5 p-4 rounded-lg">
                    <h4 className="text-sm font-medium text-gray-400 mb-2">Varaktighet</h4>
                    <p className="text-white">{activity.duration_minutes} minuter</p>
                  </div>
                )}
              </div>
            </div>
                ...
                <div className="mt-8 p-4 bg-white/5 rounded-lg">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-white">{getActivityLabel(activity.type)}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300">Skapad</span>
                      <span className="text-white">{formatDate(activity.created_at)}</span>
                    </div>
                    {activity.outcome && (
                      <div className="flex items-center justify-between">
                        <span className="text-gray-300">Resultat</span>
                        <span className="text-white">{activity.outcome}</span>
                      </div>
                    )}
                  </div>
                </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold text-white mb-2">Aktiviteter</h1>
          <p className="text-xl text-gray-300">All din kommunikation och interaktioner - enkelt och överskådligt</p>
        </div>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/10 border-blue-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-white">{todayActivities.length}</p>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-green-500/10 to-green-600/10 border-green-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-white">{callsThisWeek.length}</p>
        ...
        <GlassCard className="p-6 bg-gradient-to-br from-purple-500/10 to-purple-600/10 border-purple-500/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-white">{meetingsThisWeek.length}</p>
