...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black">
      ...
      {/* Layout Container with max width for desktop */}
      <div className="flex min-h-screen max-w-[2000px] mx-auto">
        ...
        <motion.aside
          ...
          className="fixed inset-y-0 left-0 z-50 w-80 lg:translate-x-0 lg:static lg:inset-0 lg:w-72 xl:w-80"
        >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 px-6 lg:px-8 py-8 max-w-7xl mx-auto w-full">
